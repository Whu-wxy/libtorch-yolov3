...
void showMatImage(cv::Mat image, QString win_name, int width, int height)
{
    namedWindow(win_name.toStdString(), cv::WINDOW_NORMAL);
    cv::resizeWindow(win_name.toStdString(), width, height);
